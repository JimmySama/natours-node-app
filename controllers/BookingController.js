...
exports.getCheckoutSession = CatchError(async (request, response, next) => {
    //get tour data
    const tour = await Tour.findById(request.params.tourId);
    //create checkout CheckoutSession
...
exports.createBookingCheckout = CatchError(async (request, response, next) => {
    //Temporary
