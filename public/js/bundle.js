...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"password.js":[function(require,module,exports) {
"use strict";
...
var resetPassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(password, passwordConfirm, token) {
    var result;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:3000/api/v1/users/reset-password/".concat(token),
              data: {
                password: password,
                passwordConfirm: passwordConfirm
              }
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaHdwLXNhbWEiLCJhIjoiY2thZjVtcmduMDJ5dDJxbXVsdHo2ZTE4ZyJ9.gbJl3dMdQuRhxO2p2q4MFw';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //extend map bound
...
var updateAccount = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? ' http://127.0.0.1:3000/api/v1/users/update-password/' : 'http://127.0.0.1:3000/api/v1/users/update-profile';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
  ...
  return function updateAccount(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var stripe = Stripe('pk_test_nsanZnV470i9Jd6CV2f8MmTd00JDT6S7NK');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("\n    http://127.0.0.1:3000/api/v1/bookings/checkout/".concat(tourId, "\n    "));
...
var profileForm = document.querySelector('.form-user-data');
var passwordForm = document.querySelector('.form-user-password');
var checkOutBtn = document.getElementById('check-out-btn'); //DELEGATION
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              email = document.getElementById('email').value;
              _context3.next = 5;
              return (0, _password.forgotPassword)(email);
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              passwordConfirm = document.getElementById('passwordConfirm').value;
              _context4.next = 7;
              return (0, _password.resetPassword)(password, passwordConfirm, document.getElementById('token').value);
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              console.log(document.getElementById('photo').files[0]); // console.log(form);

              _context5.next = 8;
              return (0, _account.updateAccount)(form, 'profile');
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 7;
              return (0, _account.updateAccount)({
